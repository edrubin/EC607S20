...
.hi-slate[Admin:] Zoom recordings on Canvas.
...
--
<br>.hi-purple[Assignment.sub[3]] [First step of project proposal due April 15.super[th]](https://github.com/edrubin/EC607S20/#project).

--

### Future

.hi-slate[Lab:] Meet Colleen and start deepening R knowledge.
...
pagedown::chrome_print("02-the-ideal.html", output = "02-the-ideal-nopause.pdf")
```
